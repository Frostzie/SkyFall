The classes inside package (`io.github.frostzie.datapackide.svg_icon`) are from **jsvgfx** by **mkpaz** slightly modified by Frostzie <br>

### Original Source
 - **Repository:** https://github.com/mkpaz/jsvgfx/
 - **License:** [MIT](https://github.com/mkpaz/jsvgfx/blob/master/LICENSE)
