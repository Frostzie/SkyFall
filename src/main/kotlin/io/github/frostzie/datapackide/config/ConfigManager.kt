...
object ConfigManager {
    ...
    private val defaultConfigDir: Path = Folders.configDir.resolve("datapack-ide") // TODO: Change to "Nodex"
    ...
    fun setCustomConfigPath(path: Path?) {
        try {
            ...
            logger.debug("Updated config location. New path: {}", path ?: "Default") //TODO: change to debug
        } catch (e: Exception) {
