...
class LeftSidebar : javafx.scene.layout.VBox() {
    ...
    //TODO: move svg to css files to allow custom theme icons (also fix these ones)
    private fun createButtons() {
        val folderSvg =
            "M3 6.47214C3 6.16165 3.07229 5.85542 3.21115 5.57771L4 4H9L10 6H20C20.5523 6 21 6.44772 21 7V9V19C21 19.5523 20.5523 20 20 20H4C3.44772 20 3 19.5523 3 19V9V6.47214Z " +
                    "M4 20H20C20.5523 20 21 19.5523 21 19V11C21 9.89543 20.1046 9 19 9H5C3.89543 9 3 9.89543 3 11V19C3 19.5523 3.44772 20 4 20Z "

        val searchSvg =
            "M14.9536 14.9458L21 21M17 10C17 13.866 13.866 17 10 17C6.13401 17 3 13.866 3 10C3 6.13401 6.13401 3 10 3C13.866 3 17 6.13401 17 10Z"
        ...
        val buttons = listOf(
            SidebarButton(folderSvg, "File Explorer") { onFileExplorer() },
            SidebarButton(searchSvg, "Search") { onSearch() },
            SidebarButton(runSvg, "Run") { onRun() },
            SidebarButton(settingsSvg, "Settings") { onSettings() }
        )
    ...
    private inner class SidebarButton(
        ...
        init {
            ...
            val defaultColor = Color.web("#808080")
            val hoverColor = Color.web("#FFFFFF")
            svgPath.fill = defaultColor
            svgPath.stroke = defaultColor

            this.setOnMouseEntered {
                svgPath.fill = hoverColor
                svgPath.stroke = hoverColor
            }
