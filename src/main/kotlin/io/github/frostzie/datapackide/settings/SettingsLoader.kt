...
import io.github.frostzie.datapackide.events.CloseSettingsEvent
import io.github.frostzie.datapackide.events.EventBus
import io.github.frostzie.datapackide.events.OpenProjectManagerEvent
import io.github.frostzie.datapackide.loader.fabric.Folders
...
object SettingsLoader {
    ...
    private fun updateConfigLocation() {
        ...
        val defaultPath = Folders.configDir.resolve("datapack-ide").toAbsolutePath()
    ...
    private fun copyConfigs(targetDir: Path) {
        val sourceDir = Folders.configDir.resolve("datapack-ide")
